...
import com.uniovi.tests.pageobjects.PO_ListOffers;
...
@SpringBootTest
public class SdiEntrega120211112021112ApplicationTests {
	...
	public void initdb() {
		...
		conversRepository.deleteAll();
		messagesRepository.deleteAll();
		offersRepository.deleteAll();
		usersRepository.deleteAll();

		// Reconstruimos los datos de prueba
